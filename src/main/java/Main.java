...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /* Seguro seguro = new Seguro(1, "17546586R", "Joaquin", "Soria", "Soria", 17, 0, 's', 0, Timestamp.valueOf("2013-04-22 19:05:11"), "Hogar");
        Seguro seguro1 = new Seguro(2, "22737883Z", "Maria", "Rodriguez", "Martinez", 45, 1, 'S', 3, Timestamp.valueOf("2013-04-22 19:05:12"), "Hogar");
